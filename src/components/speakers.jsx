        ...
        return (
            <section className="speakers" id="prelegenci">
                <MDBContainer>
                    ...
                    <MDBRow>
                        <Speaker name="Jakub Bobek" img="Jakub_Bobek.png" desc="Programista działający głównie z .NET. Pracuje w firmie NOVOMATIC Technologies Poland, gdzie rozwija i utrzymuje rozproszony system wspierający branżę gamingową."/>
